...
class STPM(pl.LightningModule):
    ...
    def train_dataloader(self):
        image_datasets = datasets.ImageFolder(args.dataset_path,transform=self.data_transforms)
    ...
    def test_dataloader(self):
        test_datasets = datasets.ImageFolder(root=os.path.join(args.dataset_path,args.category), transform=self.data_transforms)
...
def get_args():
    ...
    parser.add_argument('--train_dataset_path', default=r'./MVTec') 
    parser.add_argument('--test_dataset_path', default=r'./MVTec') 
