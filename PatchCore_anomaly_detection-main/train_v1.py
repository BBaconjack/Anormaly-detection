...
def prep_dirs(root):
    ...
    embeddings_path = os.path.join('./', 'embeddings', 'APPLE')
...
class STPM(pl.LightningModule):
    ...
    def train_dataloader(self):
        image_datasets = datasets.ImageFolder(args.train_dataset_path,transform=self.data_transforms)
    ...
    def test_dataloader(self):
        test_datasets = datasets.ImageFolder(root=os.path.join(args.test_dataset_path,args.category), transform=self.data_transforms)
...
def get_args():
    ...
    parser.add_argument('--category', default='Experiment_1')
    parser.add_argument('--num_epochs', default=1)
    parser.add_argument('--batch_size', default=32)
    parser.add_argument('--load_size', default=4352) # 256
    parser.add_argument('--input_size', default=4200)
...
if __name__ == '__main__':
    ...
    args = get_args()
    trainer = pl.Trainer.from_argparse_args(args, default_root_dir=os.path.join(args.project_root_path, args.category), max_epochs=args.num_epochs, gpus=4) #, check_val_every_n_epoch=args.val_freq,  num_sanity_val_steps=0) # ,fast_dev_run=True)
